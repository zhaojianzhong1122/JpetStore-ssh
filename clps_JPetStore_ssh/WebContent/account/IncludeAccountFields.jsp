...
<script type="text/javascript">
	$(function() {
		...
		$(
				"#selectlike option[value='<s:property value='profile.favcategory'/>']")
				.attr("selected", true);
		$(
		"#selectlan option[value='<s:property value='profile.langpref'/>']")
		.attr("selected", true);
...
<table>
	<tr>
		<td>喜爱的语言:</td>
		<td><select name="profile.langpref" id="selectlan">
