...
<script type="text/javascript">
	$(function() {
		...
		$("#SidebarContent img").click(
				function() {

					location.href = "categoryAction?category.catid="
							+ $(this).attr("title");

				});

		$("#MainImageContent area").click(
				function() {
...
<div id="Main">
	...
	<div id="Sidebar">
		<div id="SidebarContent">
			...
			<img src="<%=basePath%>/images/dogs_icon.gif" /> <br /> 不同品种 <br /> <img
				src="<%=basePath%>/images/cats_icon.gif" /> <br /> 不同品种，外来品种 <br />

			<img src="<%=basePath%>/images/reptiles_icon.gif" /> <br /> 蜥蜴，龟，蛇 <br />

			<img src="<%=basePath%>/images/birds_icon.gif" /> <br />外来品种
		</div>
	</div>
	...
	<div id="MainImage">
		<div id="MainImageContent">
			<map name="estoremap">
				<area alt="BIRDS" coords="72,2,280,250" href="javascript:void(0)"
					shape="RECT" />
			...
			<img height="355" src="<%=basePath%>/images/splash.gif"
