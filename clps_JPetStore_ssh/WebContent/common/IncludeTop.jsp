...
<script type="text/javascript">
		$(function(){
			...
			$("#account").click(function(){
				...
				location.href="queryInfoByUserAction?userid=<%=session.getAttribute("userid")%>";
...
<%-- 			$("#MenuContent a:first").click(function(){
			...
			$("#MenuContent a:first").click(function(){
				location.href="/clps_JPetStore_ssh/cart/Cart.jsp";
			})
		});
...
<body>
	...
	<div id="Header">
		...
		<div id="Logo">
			<div id="LogoContent">
				<a href="<%=basePath%>catalog/Main.jsp"> <img width="227"
					src="<%=basePath%>/images/logo-topbar.gif" /></a>
			</div>
		</div>

		<div id="Menu">
			<div id="MenuContent">
				<a href="javascript:void(0)"><img align="middle" name="img_cart"
					src="<%=basePath%>/images/cart.gif" /></a> <img align="middle"
					src="<%=basePath%>/images/separator.gif" /> <a
					href="javascript:void(0)" id="login">登录</a> <img align="middle"
					src="<%=basePath%>/images/separator.gif" /> <a
					href="javascript:void(0)" id="account" style="display: none">我的账户</a>
			</div>
		</div>
		...
		<div id="Search">
			<div id="SearchContent">
				<form method="post" action="">
					<input name="keyword" size="14" />&nbsp; <input type="button"
